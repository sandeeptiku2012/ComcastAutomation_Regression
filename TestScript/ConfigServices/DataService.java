...
public class AppProperties {
	...
	//Generate Random MoneyCenter UserID
	...
	static 
	{
		...
		SELENIUM_SERVER_HOST=rsbundle.getString("SELENIUM_SERVER_HOST");
		SELENIUM_SERVER_PORT=rsbundle.getString("SELENIUM_SERVER_PORT");
		...
		_NONCAPITAL_LETTER_PASSWORD=rsbundle.getString("NONCAPITAL_LETTER_PASSWORD");
